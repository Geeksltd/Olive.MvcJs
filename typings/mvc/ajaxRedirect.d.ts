...
export default class AjaxRedirect implements IService {
    ...
    goWithajaxTarget(url: string, trigger: JQuery, ajaxTarget: string, isBack?: boolean, keepScroll?: boolean, addToHistory?: boolean, onComplete?: (successful: boolean) => void): boolean;
}

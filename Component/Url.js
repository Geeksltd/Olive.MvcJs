...
class Url {
    static current() { return window.location.href; }
    static goBack() {
    ...
    static removeQuery(url, parameter) {
    ...
    static addQuery(url, key, value) { return url + (url.indexOf("?") == -1 ? "?" : "&") + key + "=" + value; }
    static removeEmptyQueries(url) {

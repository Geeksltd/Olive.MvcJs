...
var UrlHelper = (function () {
    ...
    UrlHelper.current = function () { return window.location.href; };
    UrlHelper.goBack = function () {
    ...
    UrlHelper.pathAndQuery = function () { return window.location.pathname + window.location.search; };
    UrlHelper.updateQuery = function (uri, key, value) {
        if (uri == null)
    ...
    UrlHelper.removeQuery = function (url, parameter) {
    ...
    UrlHelper.getQuery = function (name, url) {
        if (url === void 0) { url = null; }
        if (url)
            url = UrlHelper.fullQueryString(url);
        else
            url = location.search;
    ...
    UrlHelper.fullQueryString = function (url) {
    ...
    UrlHelper.addQuery = function (url, key, value) { return url + (url.indexOf("?") == -1 ? "?" : "&") + key + "=" + value; };
    UrlHelper.removeEmptyQueries = function (url) {
    ...
    UrlHelper.mergeFormData = function (items) {
        var result = [];
        var a = Array;
    ...
    UrlHelper.htmlEncode = function (html) {
        var a = document.createElement('a');
        a.appendChild(document.createTextNode(html));
        return a.innerHTML;
    };
    UrlHelper.htmlDecode = function (html) {
        var a = document.createElement('a');
        a.innerHTML = html;

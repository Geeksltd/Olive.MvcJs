define(["require", "exports", "../Components/WindowContext"], function (require, exports, WindowContext_1) {
    ...
    var SubMenu = /** @class */ (function () {
        function SubMenu(targetMenue) {
            ...
            if (options)
                this.submenuOptions = WindowContext_1.WindowContext.toJson(options);

define(["require", "exports", "../Components/WindowContext", "../Components/Url", "../Config"], function (require, exports, WindowContext_1, Url_1, Config_1) {
    ...
    var AutoComplete = /** @class */ (function () {
        ...
        AutoComplete.prototype.getData = function (query, callback) {
            ...
            url = Url_1.Url.removeQuery(url, this.input.attr('name')); // Remove old text.
            ...
            setTimeout(function () {
                ...
                $.post(url, data).fail(WindowContext_1.WindowContext.handleAjaxResponseError).done(function (result) {
